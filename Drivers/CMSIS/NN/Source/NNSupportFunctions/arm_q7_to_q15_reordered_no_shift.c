 ...
 * Description:  Converts the elements of the Q7 vector to reordered Q15 vector
 * without left-shift
 *
...
/**
 * @brief Converts the elements of the Q7 vector to reordered Q15 vector without
 * left-shift
