...
arm_status arm_mat_scale_q31(const arm_matrix_instance_q31 *pSrc,
...
#endif  //    #ifdef ARM_MATH_MATRIX_CHECK
  {
    ...
    while (blkCnt > 0U) {
      ...
      if (in1 != (out1 >> totShift)) out1 = 0x7FFFFFFF ^ (in1 >> 31);

      if (in2 != (out2 >> totShift)) out2 = 0x7FFFFFFF ^ (in2 >> 31);
      ...
      *(pOut + 1) = out2;
      ...
      if (in3 != (out3 >> totShift)) out3 = 0x7FFFFFFF ^ (in3 >> 31);

      if (in4 != (out4 >> totShift)) out4 = 0x7FFFFFFF ^ (in4 >> 31);
    ...
    while (blkCnt > 0U) {
      ...
      if (in2 != (out1 >> totShift)) out1 = 0x7FFFFFFF ^ (in2 >> 31);
