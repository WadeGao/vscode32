 ...
 * truncated to 2.30 format. These intermediate results are accumulated in a
 * 32-bit register in 2.30 format. Finally, the accumulator is saturated and
 * converted to a 1.31 result.
 *
 * \par
 ...
 * signals must be scaled down. Scale down the inputs by log2(min(srcALen,
 ...
 *
 * \par
 * See <code>arm_conv_q31()</code> for a slower implementation of this function
